...
@Component({
  selector: 'app-results-current',
  templateUrl: './results-current.component.html',
  styleUrls: ['./results-current.component.css']
})

export class ResultsCurrentComponent implements AfterViewInit {

  constructor() {
    // Read results
    const rawParticipantsData = require('../data/results.json');
  ...
  private calculateErrorRate(): void {
    ...
    this.participants.forEach((p) => {
      p.data.results.forEach((r) => {
        if (ResultsCurrentComponent.distributionIsTheSame(r.answer, this.datasets[r.dataset].distribution)) {
          this.correct += 1;
        } else {
          this.wrong += 1;
        }
  ...
  private plotDatasetTypes(): void {
    ...
    ResultsCurrentComponent.deleteSVG(this.svgPlotTypes);
    ...
    this.participants.forEach((p) => {
      p.data.results.forEach((r) => {
        ...
        if (ResultsCurrentComponent.distributionIsTheSame(r.answer, distr)) {
  ...
  private plotBinsizes(): void {
    ...
    plotFormat.width = (this.divPlotresultsParent.nativeElement.clientWidth - 40) - plotFormat.margin.left - plotFormat.margin.right;
    plotFormat.height = 200 - plotFormat.margin.bottom - plotFormat.margin.top;
    ResultsCurrentComponent.deleteSVG(this.svgPlotBinsizes);
  ...
  private plotSanitycheck1(): void {
    ...
    plotFormat.height = 200 - plotFormat.margin.bottom - plotFormat.margin.top;
    ResultsCurrentComponent.deleteSVG(this.svgPlotSanitycheck1);
  ...
  private plotSanitycheck2(): void {
    ...
    plotFormat.width = (this.divSanitycheckParent.nativeElement.clientWidth - 40) - plotFormat.margin.left - plotFormat.margin.right;
    plotFormat.height = 200 - plotFormat.margin.bottom - plotFormat.margin.top;
    ResultsCurrentComponent.deleteSVG(this.svgPlotSanitycheck2);
  ...
  private plotParticipantsAge(): void {
    ...
    ResultsCurrentComponent.deleteSVG(this.svgPlotParticipantsAge);
  ...
  private plotParticipantsResidence(): void {
    ...
    plotFormat.width = (this.divPlotParticipantsParent.nativeElement.clientWidth / 2) - plotFormat.margin.left - plotFormat.margin.right;
    plotFormat.height = 150 - plotFormat.margin.bottom - plotFormat.margin.top;
    ResultsCurrentComponent.deleteSVG(this.svgPlotParticipantsResidence);
  ...
  private plotParticipantsExperience(): void {
    ...
    plotFormat.height = 150 - plotFormat.margin.bottom - plotFormat.margin.top;
    ResultsCurrentComponent.deleteSVG(this.svgPlotParticipantsExperience);
  ...
  private plotParticipantsEducation(): void {
    ...
    plotFormat.width = (this.divPlotParticipantsParent.nativeElement.clientWidth / 2) - plotFormat.margin.left - plotFormat.margin.right;
    plotFormat.height = 150 - plotFormat.margin.bottom - plotFormat.margin.top;
    ResultsCurrentComponent.deleteSVG(this.svgPlotParticipantsEducation);
  ...
  private plotParticipantsProfession(): void {
    ...
    plotFormat.width = (this.divPlotParticipantsParent.nativeElement.clientWidth / 2) - plotFormat.margin.left - plotFormat.margin.right;
    plotFormat.height = 150 - plotFormat.margin.bottom - plotFormat.margin.top;
    ResultsCurrentComponent.deleteSVG(this.svgPlotParticipantsProfession);
  ...
  private plotParticipantsTime(): void {
    ...
    plotFormat.height = 200 - plotFormat.margin.bottom - plotFormat.margin.top;
    ResultsCurrentComponent.deleteSVG(this.svgPlotTime);
    ...
    this.participants.forEach((p) => {
      for (let i = 0; i < daysInBetween.length; i++) {
        if (i === (daysInBetween.length - 1) ||
          (p.data.timestamp >= daysInBetween[i].getTime() && p.data.timestamp < daysInBetween[i + 1].getTime())) {
  ...
  private plotDatasetDistribution(): void {
    ...
    ResultsCurrentComponent.deleteSVG(this.svgPlotDatasets);
    ...
    for (let i = 0; i < this.numDatasets; i++) {
      const datasetid = ResultsCurrentComponent.formatDatasetName(i);
    ...
    this.participants.forEach((p) => {
      p.data.results.forEach((r) => {
        const datasetid = ResultsCurrentComponent.formatDatasetName(r.dataset);
        if (ResultsCurrentComponent.distributionIsTheSame(r.answer, this.datasets[r.dataset].distribution)) {
